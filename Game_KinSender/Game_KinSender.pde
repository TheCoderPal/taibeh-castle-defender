...
void knight_shoot() {
  ...
  knight_bullet.setVelXY(1000.0f, map(knight_angle, 0, KNIGHT_MAX_ANGLE_FRAME, 0, -750));
}

void dragon_shoot() {
  dragon_bullet.setXY(682, 500);
  dragon_bullet.setVisible(true);
  dragon_bullet.setVelXY(-1000.0f, map(dragon_angle, 0, DRAGON_MAX_ANGLE_FRAME, 0, -750));
}
